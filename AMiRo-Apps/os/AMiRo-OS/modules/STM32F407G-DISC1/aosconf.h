...
/**
 * @file    aosconf.h
 * @brief   AMiRo-OS Configuration file for the STM32F407G_DISC1 module.
 * @details Contains the application specific AMiRo-OS settings.
 *
 * @defgroup stm32f407gdisc1_cfg_amiroos AMiRo-OS
 * @ingroup stm32f407gdisc1_cfg
 *
 * @brief   Todo
 * @details Todo
 *
 * @addtogroup stm32f407gdisc1_cfg_amiroos
 * @{
 */
 ...
 * @note    Any mandatory events (e.g. for SSSP) are enabled implicitely despite
 *          this configuration.
 */
 ...
 */
  ...
  #define AMIROOS_CFG_SHELL_REMOTE_ENABLE       false
