...
/**
 * @file    chconf.h
 * @brief   ChibiOS Configuration file for the STM32F407G-DISC1 module.
 * @details Contains the application specific kernel settings.
 *
 * @defgroup stm32f407gdisc1_cfg_chibiosrt ChibiOS/RT
 * @ingroup stm32f407gdisc1_cfg
 *
 * @brief   Todo
 * @details Todo
 *
 * @addtogroup stm32f407gdisc1_cfg_chibiosrt
 * @{
 */
