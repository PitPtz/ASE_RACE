 ...
 *
 * @defgroup nucleog071rb_cfg_board Board
 * @ingroup nucleog071rb_cfg
 *
 * @brief   Todo
 * @details Todo
 *
 * @addtogroup nucleog071rb_cfg_board
 * @{
 */
 ...
 */
#define LINE_STLK_RX                PAL_LINE(GPIOA, GPIOA_STLK_RX)
#define LINE_STLK_TX                PAL_LINE(GPIOA, GPIOA_STLK_TX)
