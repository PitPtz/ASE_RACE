...
static AOS_TEST(_test, "HMC5883L", "compass", moduleTestHmc5883lShellCb, aosTestHmc5883lFunc, &_data);
...
int moduleTestHmc5883lShellCb(BaseSequentialStream* stream, int argc, const char* argv[], aos_testresult_t* result)
{
  (void)argc;
  (void)argv;
