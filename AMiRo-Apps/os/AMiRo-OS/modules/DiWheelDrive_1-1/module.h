...
/**
 * @brief   Configuration for the motion sensor SPI interface  driver to
 *          communicate with the accelerometer.
 */
extern ROMCONST SPIConfig moduleHalSpiAccelerometerConfig;

/**
 * @brief   Configuration for the motion sensor SPI interface  driver to
 *          communicate with the gyroscope.
 */
extern ROMCONST SPIConfig moduleHalSpiGyroscopeConfig;
