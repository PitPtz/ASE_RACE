...
/**
 * @file    chconf.h
 * @brief   ChibiOS Configuration file for the PowerManagement v1.2 module.
 * @details Contains the application specific kernel settings.
 *
 * @defgroup powermanagement12_cfg_chibiosrt ChibiOS/RT
 * @ingroup powermanagement12_cfg
 *
 * @brief   Todo
 * @details Todo
 *
 * @addtogroup powermanagement12_cfg_chibiosrt
 * @{
 */
