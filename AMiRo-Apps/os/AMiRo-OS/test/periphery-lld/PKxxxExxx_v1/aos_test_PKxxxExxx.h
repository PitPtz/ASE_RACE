...
/**
 * @file    aos_test_PKxxxExxx.h
 * @brief   Buzzer driver test types and function declarations.
 *
 * @defgroup test_PKxxxExxx_v1 PKxxxExxx (v1)
 * @ingroup test
 * @brief   Buzzer driver test.
 *
 * @addtogroup test_PKxxxExxx_v1
 * @{
 */

#ifndef AMIROOS_TEST_PKxxxExxx_H
#define AMIROOS_TEST_PKxxxExxx_H
...
#endif /* AMIROOS_TEST_PKxxxExxx_H */
