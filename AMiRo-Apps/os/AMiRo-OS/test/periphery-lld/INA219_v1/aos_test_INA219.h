...
/**
 * @file    aos_test_INA219.h
 * @brief   Power monitor driver test types and function declarations.
 *
 * @defgroup test_INA219_v1 INA219 (v1)
 * @ingroup test
 * @brief   Power monitor driver test.
 *
 * @addtogroup test_INA219_v1
 * @{
 */

#ifndef AMIROOS_TEST_INA219_H
#define AMIROOS_TEST_INA219_H
