...
/**
 * @file    aos_test_switch.h
 * @brief   Generic switch driver test types and function declarations.
 *
 * @defgroup test_switch_v1 switch (v1)
 * @ingroup test
 * @brief   Generic switch driver test.
 *
