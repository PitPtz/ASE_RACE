...
/**
 * @file    aos_test_bq27500.h
 * @brief   Fuel gauge driver test types and function declarations.
 *
 * @defgroup test_bq27500_v1 bq27500 (v1)
 * @ingroup test
 * @brief   Fuel gauge driver test.
 *
 * @addtogroup test_bq27500_v1
 * @{
 */

#ifndef AMIROOS_TEST_BQ2750_H
#define AMIROOS_TEST_BQ2750_H
