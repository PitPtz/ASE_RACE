 ...
 *
 * @defgroup lld_VCNL4020_v1 Version 1
 * @brief   Version 1
 * @ingroup lld_VCNL4020
 *
 * @addtogroup lld_VCNL4020_v1
 * @{
 */
...
typedef enum {
  ...
  VCNL4020_LLD_ALPARAMREG_AUTOOFFSET_DEFAULT  = 0x08u, /**< Auto offset compensation flag default value (enabled) */
