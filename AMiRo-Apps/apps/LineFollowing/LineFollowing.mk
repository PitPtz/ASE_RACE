...
LineFollowing_DIR := $(realpath $(dir $(lastword $(MAKEFILE_LIST))))
...
# include path
LineFollowing_INC = $(LineFollowing_DIR)

# C source files
LineFollowing_CSRC = $(LineFollowing_DIR)/linefollowing.c 

# C++ source files
LineFollowing_CPPSRC =
