...
ObstacleAvoidance_DIR := $(realpath $(dir $(lastword $(MAKEFILE_LIST))))
...
# include path
ObstacleAvoidance_INC = $(ObstacleAvoidance_DIR)

# C source files
ObstacleAvoidance_CSRC = $(ObstacleAvoidance_DIR)/obstacleavoidance.c 
