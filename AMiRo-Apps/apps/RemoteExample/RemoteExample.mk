...
RemoteExample_DIR := $(realpath $(dir $(lastword $(MAKEFILE_LIST))))
...
# include path
RemoteExample_INC = $(RemoteExample_DIR)

# C source files
RemoteExample_CSRC = $(RemoteExample_DIR)/remoteexample.c 

# C++ source files
RemoteExample_CPPSRC =
