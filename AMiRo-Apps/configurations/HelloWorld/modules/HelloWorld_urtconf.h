...
/**
 * @file    HelloWorld_urtconf.h
 * @brief   µRT configuration file for the HelloWorld configuration.
...
#ifndef HELLOWORLD_URTCONF_H
#define HELLOWORLD_URTCONF_H
