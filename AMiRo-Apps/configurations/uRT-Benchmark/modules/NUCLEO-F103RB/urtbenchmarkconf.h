 ...
 *
 * @addtogroup configs_urtbenchmark_modules_nucleof103rb
 * @{
 */
...
// core configuration
#define URTBENCHMARK_CFG_NUMNODES                 10
#define URTBENCHMARK_CFG_REPETITIONS              50
#define URTBENCHMARK_CFG_FREQUENCY                100.0f

// publish-subscribe & RPC common configuration
#define URTBENCHMARK_CFG_NUMHOPS                  10
...
#define URTBENCHMARK_CFG_NUMPUBLISHERS            10
#define URTBENCHMARK_CFG_NUMSUBSCRIBERS           10
#define URTBENCHMARK_CFG_NUMTOPICS                10
#define URTBENCHMARK_CFG_NUMMESSAGES              10

// RPC configuration
#define URTBENCHMARK_CFG_NUMREQUESTS              10
#define URTBENCHMARK_CFG_NUMSERVICES              10
