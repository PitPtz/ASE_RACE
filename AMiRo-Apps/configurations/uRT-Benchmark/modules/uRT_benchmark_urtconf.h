...
/**
 * @file    urt_benchmark_urtconf.h
 * @brief   µRT configuration file for the Benchmark configuration.
...
#ifndef BENCHMARK_URTCONF_H
#define BENCHMARK_URTCONF_H
...
#define URT_CFG_DEBUG_ENABLED                   false
#endif
