...
/**
 * @file    AMiRoDefault_urtconf.h
 * @brief   µRT configuration file for the AMiRoDefault configuration.
...
#ifndef AMiRoDefault_URTCONF_H
#define AMiRoDefault_URTCONF_H
